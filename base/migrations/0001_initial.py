# Generated by Django 3.2.7 on 2023-02-22 11:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_id', models.CharField(max_length=200, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('include_VAT', models.BooleanField(choices=[(False, 'No'), (True, 'Yes')], default=False, verbose_name='Include VAT?')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('is_sent', models.BooleanField()),
                ('buyer_business_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.buyer')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
